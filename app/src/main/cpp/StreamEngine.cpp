...
void StreamEngine::startStream(AAudioStream *stream) {
    ...
    /// fh 6, per https://developer.android.com/ndk/guides/audio/aaudio/aaudio
...
void StreamEngine::openPlaybackStream() {
    ...
    // [fh] Now start the stream so we can read from it during playback
...
///fh2 step 1 of https://developer.android.com/ndk/guides/audio/aaudio/aaudio
    AAudioStreamBuilder *builder = createStreamBuilder();

    if (builder != nullptr) {
///fh3 step 2 of https://developer.android.com/ndk/guides/audio/aaudio/aaudio
        setupPlaybackStreamParameters(builder);
///fh5 step 3 of https://developer.android.com/ndk/guides/audio/aaudio/aaudio
...
//    AAudioStreamBuilder_setDirection(builder, AAUDIO_DIRECTION_OUTPUT);
    ...
    AAudioStreamBuilder_setBufferCapacityInFrames(builder, 256); //fh
